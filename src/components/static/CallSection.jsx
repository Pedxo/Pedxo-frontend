...
export const CallSection = () => {
  ...
  return (
    <MaxScreenWrapper className="px-4 md:px-24 flex flex-col items-center gap-6 md:gap-10">
      {/* First Header + Image */}
      <SectionHeader
        title="Vibe hiring at pedxo for supporting your AI agents 🤖"
        description="pedxo robot is searching using Full Self-Driving agent to source and recruit the right teleoperator to support your AI Agents."
      />
      ...
      <SectionHeader
        ...
        description="Use AI-driven recruiting to Add and Combine the right remote engineer behind your Claude code IDE and RL environments."
      />
      <ImageCard src={Expert} alt="Expert engineers illustration" />

      {/* Third Header + Image */}
      <SectionHeader
        title="Human + Automated recruiter for hiring for AI coding agents and RL environments"
        description="Keep the right human in-the-loop to review and debug the code your agent generated for a more creative output by using pedxo AI recruiting agent."
      />
      ...
      <InfoCard
        ...
        content="Save the back and forth of manually sourcing and interviewing talent processes.
Just create your requirement contract and onboard the right virtual engineer in under 5 minutes."
