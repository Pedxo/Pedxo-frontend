...
export const HumanLoopSection = () => {
  return (
    <MaxScreenWrapper className="bg-[#181B20] rounded-none md:rounded-3xl py-8 md:py-14 px-4 md:px-24 flex flex-col items-center gap-6 md:gap-10">
      <SectionHeader
        title="Full Self-driving recruiter for AI Agents and Human-in-the-loop tools"
        description="Human + autonomous recruiting for your code agents and RL environments.
Usecase: Use it to recruit remote engineers autonomously to support your AI agents with edge cases
"/>
      ...
      <MaxScreenWrapper className="max-w-[774px] w-full relative flex items-center">
        <FeatureCard
          ...
          title="AI Autodraft and Contract drafting Agent"
          description="Use automated Agreement creating agent to send your remote engineer an NDA and get a signed document version back.
"
        />
      </MaxScreenWrapper>
      ...
      <MaxScreenWrapper className="flex flex-col max-w-[990px] gap-6 md:gap-10">
        <SectionHeader
          title="Use Full Self-Driving agent to source and recruit the right teleoperator to support your AI Agents"
          description="Recruit the right remote engineer for your AI use-case by creating a requirement prompt and have the agent onboard the right candidate for you autonomously. Boom that's it.
"
          width="70%"
        />
        ...
        <InfoCard
          ...
          content="Hire the right engineer by just using a good prompt and pedxo agent will onboard the right candidate for your role"
        />

        <InfoCard
          title="Best For"
          content="Founders who're hiring remote engineers to support their code agents with edge case tasks and wants to automate the recruiting process"
        />
