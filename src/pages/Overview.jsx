            ...
            <div>
              ...
              <div className="flex justify-between bg-white border  rounded-2xl py-3 px-[21px] xl:py-10 xl:px-16">
                ...
                <Link
                  ...
                  className="flex items-center text-[0.8rem] text-white overview-expense-bgs px-3 py-[10px] sm:px-5 sm:py-[14px] pr-bg-clr rounded-lg font-semibold xl:text-[16px]"
                >
